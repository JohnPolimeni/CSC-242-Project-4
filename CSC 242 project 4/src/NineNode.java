...
public class NineNode {
	...
	public void printBoard(){
		...
		for(int i = 0; i < 3; i++){
			...
			System.err.print(nineBoard[i][0].board[0][0] + "" + nineBoard[i][0].board[0][1] + "" + nineBoard[i][0].board[0][2]); System.err.print("   ");
			System.err.print(nineBoard[i][1].board[0][0] + "" + nineBoard[i][1].board[0][1] + "" + nineBoard[i][1].board[0][2]); System.err.print("   ");
			System.err.print(nineBoard[i][2].board[0][0] + "" + nineBoard[i][2].board[0][1] + "" + nineBoard[i][2].board[0][2]); System.err.print("\n");

			System.err.print(nineBoard[i][0].board[1][0] + "" + nineBoard[i][0].board[1][1] + "" + nineBoard[i][0].board[1][2]); System.err.print("   ");
			System.err.print(nineBoard[i][1].board[1][0] + "" + nineBoard[i][1].board[1][1] + "" + nineBoard[i][1].board[1][2]); System.err.print("   ");
			System.err.print(nineBoard[i][2].board[1][0] + "" + nineBoard[i][2].board[1][1] + "" + nineBoard[i][2].board[1][2]); System.err.print("\n");

			System.err.print(nineBoard[i][0].board[2][0] + "" + nineBoard[i][0].board[2][1] + "" + nineBoard[i][0].board[2][2]); System.err.print("   ");
			System.err.print(nineBoard[i][1].board[2][0] + "" + nineBoard[i][1].board[2][1] + "" + nineBoard[i][1].board[2][2]); System.err.print("   ");
			System.err.print(nineBoard[i][2].board[2][0] + "" + nineBoard[i][2].board[2][1] + "" + nineBoard[i][2].board[2][2]); System.err.print("\n\n");
			...
			for(int j = 0; j < 3; j++){
				if(nineBoard[(this.currentNode-1)/3][(this.currentNode - 1)/3].isEmpty(i, j)){
					...
					if(nextPlayer == 1){
						...
						System.err.println("FATAL ERROR AT FILLCHILDREN() 1");
					}
...
//								nineBoard[i][j].fillCildren();
	...
	public static NineNode alphaBetaSearch(NineNode state, int depth){
		...
		if(state.nextPlayer == 1){
			System.err.println("maxing \t****Please Wait ****");
			tempPointer = maxValue(state, -99999, 99999, depth);
		} else if(state.nextPlayer == 2){
			System.err.println("min-ing \t****Please Wait ****");
			tempPointer = minValue(state, -99999, 99999, depth);
		} else {
			System.err.println("FATAL ERROR AT ALPHABETASEARCH 1");
			tempPointer = new NineNode(-1, state.currentNode);
		}

		
		
		System.err.println("moves considered: " + count);
		count = 0;
	...
	public static NineNode maxValue(NineNode state, int alpha, int beta, int depth){
		...
		if(depth == 0){
			//System.err.println("using heuristic");
			state.setUtility();
			return state;
		}
